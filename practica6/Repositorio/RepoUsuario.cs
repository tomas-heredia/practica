    ...
    public class RepoUsuario:IRepoUsuario {
        ...
        public bool verificarUsuario(Usuario Usuario){
            using (SqliteConnection conexion = new SqliteConnection(connectionString)) 
            {
                ...
                insertar.Parameters.AddWithValue("@nombre", Usuario.NombreUsuario);
                insertar.Parameters.AddWithValue("@id", Usuario.IdUsuario);
                ...
                while (query.Read())
                    ...
                    if (query["Telefono"] != System.DBNull.Value)
                    {
                        Telefono=Convert.ToInt32( query["Telefono"]);
                                                                ...
                                                                //ID,           Nombre                    
                        ListaUsuarios.Add(new Usuario(query.GetInt32(0), query.GetString(1),Telefono,query.GetBoolean(3)));
                    }
                conexion.Close();
                }
                ...
                while (query.Read())
                {
                    ...
                    if (query["Telefono"] != System.DBNull.Value)
                    {
                        Telefono=Convert.ToInt32( query["Telefono"]);
                                                ...
                                                //ID,              Nombre                    
                    nuevoUsuario = new Usuario(query.GetInt32(0), query.GetString(1),Telefono, query.GetBoolean(3)  );
                }   
                conexion.Close();
                return nuevoUsuario;
                }
